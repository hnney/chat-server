...
public:
    ...
    string& get_ls_client_id() { return logic_server_client_ip_;}
    int get_ls_client_bind_port() { return logic_server_client_bind_port_;}
    int get_ls_client_port() { return logic_server_client_port_;}
...
private:
    ...
    string logic_server_client_ip_;
    int logic_server_client_bind_port_;
    int logic_server_client_port_;
